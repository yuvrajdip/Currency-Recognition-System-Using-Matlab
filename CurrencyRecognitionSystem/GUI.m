...
% Last Modified by GUIDE v2.5 24-Jan-2022 21:07:22
...
% --- Executes on button press in intput_PushButton.
function intput_PushButton_Callback(hObject, eventdata, handles)
% hObject    handle to intput_PushButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
pic51 = imread('Currency\Bangladeshi taka_2.jpg');
pic52 = imread('Currency\50tk.jpg');

%extracting features from the pictures of dataset
p1 = calculate(pic1);
p2 = calculate(pic2);
p3 = calculate(pic3);
p4 = calculate(pic4);
...
global currency;
global country;
set(handles.currency_field,'String',currency);
set(handles.country_field,'String',country);
disp(currency);
disp(country);


function currency_field_Callback(hObject, eventdata, handles)
% hObject    handle to currency_field (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currency_field as text
%        str2double(get(hObject,'String')) returns contents of currency_field as a double


% --- Executes during object creation, after setting all properties.
function currency_field_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currency_field (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function country_field_Callback(hObject, eventdata, handles)
% hObject    handle to country_field (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of country_field as text
%        str2double(get(hObject,'String')) returns contents of country_field as a double


% --- Executes during object creation, after setting all properties.
function country_field_CreateFcn(hObject, eventdata, handles)
% hObject    handle to country_field (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
